...
const AuctionItem = () => {
  ...
  const handleBid = () => {
    ...
    dispatch(placeBid(id, { auctionId: id, amount: Number(amount) }));
    setAmount("");
  };
              ...
              Date.now() <= new Date(auctionDetail.endTime) ? (
                <>
                  <div className="flex gap-3 flex-col sm:flex-row sm:items-center">
                    ...
                    <input
                      type="number"
                      className="w-full sm:w-40 px-4 py-2 text-[16px] md:text-[18px] bg-black border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#D6482B] focus:border-[#D6482B] transition duration-300"
                      value={amount}
