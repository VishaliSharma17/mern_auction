...
const Contact = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-15 pt-20 lg:pl-[348px] flex flex-col min-h-screen py-10 justify-start ">
        <div className="bg-white mx-auto w-full h-auto px-6 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          <form
