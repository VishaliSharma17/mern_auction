  ...
  return (
    <>
      <section className="my-8 lg:px-5">
                ...
                return (
                  <tr key={element._id} className="border-b border-gray-300">
                    <td className="flex gap-2 items-center py-2 px-4">
                      <span className="text-red-600 font-semibold text-xl w-7 hidden sm:block">
                        {index + 1}
                      </span>
                      <span>
                        <img
        ...
        <Link
          to={"/leaderboard"}
          className="border-2 border-red-200 font-bold text-xl w-full py-2 flex justify-center rounded-md hover:border-red-600 transition-all duration-300"
        >
          Go to Leaderboard
        </Link>
      </section>
