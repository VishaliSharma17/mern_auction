    ...
    <>
      ...
      >
        <div className="relative">
          <Link to={"/"}>
            <h4 className="text-2xl font-semibold mb-4  focus:outline-none">
        ...
        <div>
          <div className="flex gap-2 items-center mb-2">
            <Link
              to="/"
              className="bg-white text-blue-700 p-2 text-sl rounded-sm hover:text-blue-400"
            >
              <FaFacebook />
            </Link>
            <Link
              to="/"
              className="bg-white text-pink-600 p-2 text-sl rounded-sm hover:text-pink-400"
            >
              {/* <RiInstagramFill /> */}
              <FaInstagramSquare />
            </Link>
            <Link
              to="/"
              className="bg-white text-blue-600 p-2 text-sl rounded-sm hover:text-blue-400"
            >
              <SiLinkedin />
            </Link>
          </div>
          <Link
            to={"/contact"}
            className="text-rose-500 font-semibold hover:text-[#d6482b] hover:transition-all hover:duration-150"
          >
            {" "}
            Contact US
          </Link>
          ...
          <p className="text-stone-500">
            ...
            <Link
              to={"/"}
              className="text-red-500 font-semibold hover:text-[#d6482b] hover:transition-all hover:duration-150"
            >
              Vishali Sharma
            </Link>
          </p>
