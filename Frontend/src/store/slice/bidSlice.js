...
import { getAuctionDetail } from "./auctionsSlice";
...
export const placeBid = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`https://mern-auction-platform-backendcode.onrender.com/api/v1/bid/place/${id}`, data, {
